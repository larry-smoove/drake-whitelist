import{An as e,Cn as t,Lo as n,Mn as r,Pi as i,Vo as a,b as o,ei as s,zo as c}from"./index-mAOZwWWo.js";import{t as l}from"./createLucideIcon-Bf2XoYZc.js";import{t as u}from"./check-DEioC7mn.js";import{t as d}from"./poll-B_TitGtW-BKra5b9Y.js";import{t as f}from"./circle-x-CdhwvKmE.js";import{t as p}from"./hourglass-BvVlBgoj.js";import{t as m}from"./ScreenLayout-CDMN0cjt-MEte9f6y.js";import{t as h}from"./InfoBanner-DkQEPd77-DmqIY4-2.js";import{n as g}from"./CopyableText-D2t3Xzed-CFwUegiU.js";import{n as _,r as v,t as y}from"./SelectSourceAsset-D_IVsy_6-CJd-_qiF.js";var b=l(`user-check`,[[`path`,{d:`m16 11 2 2 4-4`,key:`9rsbq5`}],[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`,key:`1yyitq`}],[`circle`,{cx:`9`,cy:`7`,r:`4`,key:`nufk8`}]]),x=n(),S=a(c(),1),C=a(s(),1),w=e=>{try{return e.location.origin}catch{return}},T=({data:e,onClose:t})=>(0,x.jsx)(m,{showClose:!0,onClose:t,title:`Initiate bank transfer`,subtitle:`Use the details below to complete a bank transfer from your bank.`,primaryCta:{label:`Done`,onClick:t},watermark:!1,footerText:`Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately`,children:(0,x.jsx)(E,{children:(o[e.deposit_instructions.asset]||[]).map((([t,n],r)=>{let i=e.deposit_instructions[t];if(!i||Array.isArray(i))return null;let a=t===`asset`?i.toUpperCase():i,o=a.length>100?`${a.slice(0,9)}...${a.slice(-9)}`:a;return(0,x.jsxs)(D,{children:[(0,x.jsx)(O,{children:n}),(0,x.jsx)(g,{value:a,includeChildren:C.isMobile,children:(0,x.jsx)(k,{children:o})})]},r)}))})}),E=t.ol`
